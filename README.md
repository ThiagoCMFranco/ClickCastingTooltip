...
/ClickCastingTooltip bindings: Toggle Click Casting Bindings Panel.  
/cct bindings: Toggle Click Casting Bindings Panel.  
/ClickCastingTooltip config: toggle addon configuration window.  
/cct config: toggle addon configuration window.  
...
3. Delete te files named ClickCastingTooltip.lua and ClickCastingTooltip.lua.bak.  
4. Open tha game.  
